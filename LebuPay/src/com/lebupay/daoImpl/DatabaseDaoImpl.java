...
import com.lebupay.dao.DatabaseDAO;
...
public class DatabaseDaoImpl extends BaseDao implements DatabaseDAO{
	...
	public int checkTableName(String tableName) {
		...
		try {
			...
			//String query = "SELECT table_name FROM information_schema.tables where table_schema='lebupaydb'";
	...
	public String fetchQuery(String query) {
		...
		try {
			result = "<table width='100%' align=\"center\" cellpadding=\"0\" cellspacing=\"0\" border=1 style=\"border-collapse: collapse\" bordercolor=\"#111111\" >\r\n\t";
