				...
				<section class="formWrapper">
					<div class="container fullContainer">
								...
								<div class="cardSec">
									<ul>
										<li><a href="#"><img
												...
												width="330" height="50"></a></li>
										<li><a href="#"><img
												src="<%=basePath%>resources/images/diners_club_logo.png" alt=""
												></a></li>
										<li><a href="#"><img
												src="<%=basePath%>resources/images/mastercard_logo.png" alt=""
												></a></li>
										<li><a href="#"><img
												src="<%=basePath%>resources/images/visa.jpg" alt=""
												></a></li>
									</ul>
								</div>
							</div>
						...
						<form id="merchantRegistration" class="registrationForm"
							name="registrationForm" method="post" action="edit-company">
							...
							<div class="row">
								...
								<div class="col-md-3 col-lg-2 col-xs-2  bankUse">
									<span>Bank use only</span>
								</div>
								<div class="col-md-5 col-lg-5 col-xs-12 marchantCategory">
									<label>Merchant Category Code</label> <input type="text"
										class="codeSec" name="codeSec" value="${companyModel.codeSec}">
								</div>
								<div class="col-md-4 col-lg-4 col-xs-12 marchantId">
								...
								<div class="col-md-12 col-lg-12 form-group eachFld">
									<div class="leftColumn form-group eachFld typeFld">
										...
										<div class="checkgroup" id="abc">
											...
											<c:if test="${not empty companyModel.service}">
											<%-- <c:out value="${companyModel.service}">${companyModel.service}</c:out> --%>
                                              <script type="text/javascript">
                                              
                                              var str = '${companyModel.service}';
                                              
                                              
                                              if(str.includes('Proprietor')){
                                            	  $('[value="Proprietor"]').prop("checked", true);
                                              }
                                              if(str.includes('Partnership')){
                                            	  $('[value="Partnership"]').prop("checked", true);
                                              }
                                              if(str.includes('Limited company')){
                                            	  $('[value="Limited company"]').prop("checked", true);
                                              }
                                              if(str.includes('Trust')){
							...
							<div class="row">
								...
								<div class="col-md-12 col-lg-12 form-group eachFld othersBank">
									...
									<div class="checkgroup" id="def">
										...
										<c:if test="${not empty companyModel.otherBank}">
											<%-- <c:out value="${companyModel.service}">${companyModel.service}</c:out> --%>
                                              <script type="text/javascript">
                                              
                                              var str = '${companyModel.otherBank}';
                                              
                                            
                                              if(str.includes('BRAC')){
                                            	  $('[value="BRAC"]').prop("checked", true);
                                              }
                                              if(str.includes('city')){
                                            	  $('[value="city"]').prop("checked", true);
                                              }
                                              if(str.includes('Dutch-Bangla')){
