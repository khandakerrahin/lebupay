...
<body>
				...
				<c:forEach var="faqModel" items="${faqModels }" varStatus="loop">
					<div class="panel panel-default">
						...
						<div id="collapse${loop.index }"
							class="panel-collapse collapse <c:if test="${loop.index == 0 }">in</c:if>">
							<div class="panel-body">${faqModel.answer }</div>
							<!--/.panel-body -->
						</div>
						<!--/.panel-collapse -->
					</div>
	...
	<div class="modal fade lp-modal" id="customer_forget_password_modal"
		role="dialog">
	...
	<div class="modal fade lp-modal"
		id="customer_mobile_verification_modal" role="dialog">
		<div class="modal-dialog lp-modal-dialog" role="document">
			<div class="modal-content lp-modal-content">
				<div class="modal-header lp-modal-header">
					<button type="button" class="close lp-modal-close"
	...
	<div class="modal fade lp-modal" id="customer_signup_form_modal"
		role="dialog">
		<div class="modal-dialog lp-modal-dialog" role="document">
			<div class="modal-content lp-modal-content">
				<div class="modal-header lp-modal-header">
	...
	<div class="modal fade lp-modal" id="customer_login_modal_form"
		role="dialog">
		<div class="modal-dialog lp-modal-dialog" role="document">
			<div class="modal-content lp-modal-content">
				<div class="modal-header lp-modal-header">
