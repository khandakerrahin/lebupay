...
<script src="<%=basePath11%>resources/js/merchantHome.js"></script>
...
$(document).ready(function(){
	...
	var arr = window.location.pathname.split("/");
	var pathName = arr[arr.length-1];
	$("#navbar2").find('a[href="'+ pathName +'"]').parent().addClass("active");
