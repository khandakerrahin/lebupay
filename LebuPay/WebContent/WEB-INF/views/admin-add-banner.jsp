		...
		<div class="col-md-12">
			<div class="adminformBox panelAdmin borderGreen">
				<div class="panel panel-default">
					...
					<form method="post" action="add-banner"
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="form-group">
										<label class="input-group-btn uploadBtn"
											style="display: inline-block; vertical-align: middle; width:auto;"> <span
										...
										<div
											style="display: inline-block; font-size: 12px; margin-top: 10px; vertical-align:top;">(Accepts
