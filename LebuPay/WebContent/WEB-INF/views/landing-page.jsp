    ...
    <body>
    	...
    	<section class="sec_banner01 bg-image-full sec_banner01_mobile">
        	<div class="container">
            	<div class="row"> 
                	<div class="col-lg-12">
                		<button data-toggle="modal" class="btn-lg merchant-login-btn" data-target="#merchant_login_modal_form"> MERCHANT LOGIN </button>
                    </div>
                </div> 
            	<div class="row"> 
                	<div class="col-lg-6">
          				<img class="image_full_width banner_01" src="<%=basePath%>resources/images/banner_image01.png" alt="">
                    </div>
                </div>
          	</div>
        </section>
        ...
        <section class="sec_banner02 sec_banner02_mobile">
        	<div class="container">
            	<div class="row"> 
                	<div class="col-lg-6">
          				<img class="image_full_width banner_01" src="<%=basePath%>resources/images/banner_image02.png" alt="">
                    </div>
                </div>
          	</div>
        </section>
                	...
                	<div class="col-lg-12 text-center">
                        ...
                        <div class="row text-center"> 
                            <div class="col-lg-4 col-sm-4 col-xs-12"> 
                            	<div class="fbox">
                                    <img src="<%=basePath%>resources/images/social_payment_link_icon.png" alt="social payment link">
                                    <h4 class="fea_subhead"> Social Payment Link </h4>
                                    <p class="feature_brief"> 
                                        One click payment link for Facebook, <br/> Messenger, SMS, or any other social media platform
                                    </p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-4 col-xs-12"> 
                            	<div class="fbox">
                                    <img src="<%=basePath%>resources/images/payment_form_icon.png" alt="All forms of Payment">
                                    <h4 class="fea_subhead">All Forms of Payment</h4>
                                    <p class="feature_brief"> 
                                         Payment through credit/debit cards,<br/> bKash, Rocket, bank accounts, or agent banking
                                    </p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-4 col-xs-12"> 
                            	<div class="fbox">
                                    <img src="<%=basePath%>resources/images/emi_payment_icon.png" alt="EMI payment">
                                    <h4 class="fea_subhead">EMI Payment </h4>
                                    <p class="feature_brief"> 
                                        Convenience of paying through EMI
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="row text-center"> 
                        	<div class="col-lg-4 col-lg-offset-2 col-sm-4 offset-xs-0 col-xs-12"> 
                            	<div class="fbox">
                                    <img src="<%=basePath%>resources/images/website_integration_icon.png" alt="Web Integration">
                                    <h4 class="fea_subhead">Web Integration </h4>
                                    <p class="feature_brief"> 
                                        Easy integration with websites via API
                                    </p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-4 col-xs-12"> 
                            	<div class="fbox">
                                    <img src="<%=basePath%>resources/images/business_tools_icon.png" alt="Business Tools">
                                    <h4 class="fea_subhead">Business Tools </h4>
                                    <p class="feature_brief"> 
                                        Dashboard and other features for <br/>managing all transactions
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <section class="sec_banner04">
        	<div class="container">
            	<div class="row"> 
                	<div class="col-lg-6">
          				<h2 class="pricing_head"> <span style="font-weight:bold; font-size:1em;"> For Pricing </span> <br/> or other questions </h2>
                        <div class="cont"> 
                        	<form> 
                            	<div class="row">
                                ...
                                <div class="row">
                                	<label for="mail" class="col-lg-3 col-xs-4"> Mail- </label>
                                	<span class="col-lg-5"> info@lebupay.com</span>
        	...
        	<div class="container">
            	<div class="row"> 
                	<div class="col-lg-6 col-lg-offset-6 col-xs-12 ">
                        ...
                        <p class="grn"> LebuPay is brought to you by Spider Digital Commerce (Bangladesh) Ltd. We help our partners to organize lead product and service innovation initiaves in the digital space. We use design principles and innovation models to help our partners create and capture value in the digital economy. </p>
                        <div> <a href="http://www.spiderdigital.io/" class="white_rounded_btn"> Know more </a> </div>
                    </div>
                </div>
          	</div>
        </section>
            	...
            	<div class="row"> 
                	<div class="col-lg-8"> 
                    	<p class="copyright_info"> 
                        	&copy; All rights reserved to Spider Digital Commerce (Bangladesh) Ltd
                        </p>
                    </div>
                    <div class="col-lg-4"> 
                    	<div class="social"> 
								...
								<div class="lp-terms-line lp-forgot-password-link">
									<div class="row">
										<a class="col-xs-6" href="javascript:void(0)"
											...
											data-target="#merchant_signup_form_modal">Sign Up</a> 
											<a
