				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table id="merchant" class="table display" cellspacing="0"
							...
							<tbody>
								<c:forEach var="merchantModel" items="${activedMerchants }"
									varStatus="loop">
...
<script type="text/javascript">
	$(document).ready(function() {
		var urlConfigObj = {"noOfPages":2, "url": "list-actived-merchant", "method":"POST"};
        ...
        var columns = [
         ...
         { "data": "status", "defaultContent": "" },
         {
        	 "data": null,
             className: "center",
             defaultContent: '<a href="" class="edit" data-url="edit-merchant" data-target="merchantId"><i class="fa fa-pencil-square-o"></i></a>  <!-- <a href="" data-url="delete-sub-merchant" data-target="merchantId" class="remove"><i class="fa fa-trash-o"></i></a> -->'
         }
        ];
        ...
        drawDataTable($("#merchant"), urlConfigObj, columns, columnsVSTable, true, null, null, ${totalSize }, "downloadActivedMerchantListExcel", changeActiveDeactive, 'rtp', $(".mySearch"), $(".myExcelDownload"), $(".mySelectOpt"));
