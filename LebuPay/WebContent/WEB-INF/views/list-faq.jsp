							...
							<tbody>
								<c:forEach var="faqModel" items="${faqModels }" varStatus="loop">
									<tr class="${((loop.index +1)%2)==0?'odd':'even'}">
										<td>${faqModel.faqId }</td>
										<td>${faqModel.question }</td>
										<td>${faqModel.answer }</td>
										<td>${faqModel.typeModel.typeName }</td>
										<td>${faqModel.status }</td>
										<td><a href="" class="edit" data-url="edit-faq"
											data-target="faqId"><i class="fa fa-pencil-square-o"></i></a>
											<!-- <a href="" data-url="delete-faq" data-target="faqId"
...
<script type="text/javascript">
	$(document).ready(function() {
		var urlConfigObj = {"noOfPages":2, "url": "list-faq", "method":"POST"};
        ...
        var columnsVSTable = {"typeModel.typeName":"TM.type_name", "faqId":"FAQ_ID"};
        var columns = [
		 { "data": "faqId", "defaultContent": "", "visible": false },
         ...
         { "data": "status", "defaultContent": "" },
         {
        	 "data": null,
             className: "center",
             defaultContent: '<a href="" class="edit" data-url="edit-faq" data-target="faqId"><i class="fa fa-pencil-square-o"></i></a>   <!-- <a href="" data-url="delete-faq" data-target="faqId" class="remove"><i class="fa fa-trash-o"></i></a> -->'
         }
        ];
        ...
        drawDataTable($("#faq"), urlConfigObj, columns, columnsVSTable, true, null, null, ${totalSize }, "downloadFaqListExcel", changeActiveDeactive, 'rtp', $(".mySearch"), $(".myExcelDownload"), $(".mySelectOpt"));
