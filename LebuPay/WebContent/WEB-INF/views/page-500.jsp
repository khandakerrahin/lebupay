	...
	<div class="mainWraper">
		...
		<div class="wraper">
			<div class="waterMark error">
				<h1 class="errorHead">500</h1>
				<p>Internal Server Error</p>
				<span>We track these errors automatically, but if the problem
					persists feel free to contact us.<br /> In the meantime, try
					refreshing.
				</span> <a href="<%=basePath%>index">Go To Login Page</a>
			</div>
		</div>
	</div>
</body>
